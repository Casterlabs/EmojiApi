...
public class EmojiApi extends SoraPlugin {
    ...
    public void onInit(Sora sora) {
        ...
        sora.addProvider(this, new EmojiIndexRoutes(this.index));
        sora.addProvider(this, new EmojiCategoryRoutes(this.index));
        sora.addProvider(this, new EmojiSubcategoryRoutes(this.index));
        sora.addProvider(this, new EmojiRoutes(this.index));
        sora.addProvider(this, new EmojiDetectionRoute(this.index));
    }
